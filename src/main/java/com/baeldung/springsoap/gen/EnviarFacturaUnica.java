...
/**
 * <p>Clase Java para enviarFacturaUnica complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="enviarFacturaUnica"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "enviarFacturaUnica", propOrder = {
    "tramaenviofu"
})
public class EnviarFacturaUnica {
